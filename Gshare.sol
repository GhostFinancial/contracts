...
contract Gshare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Gshare Shares", "GSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 GHOST Share for initial pools deployment
